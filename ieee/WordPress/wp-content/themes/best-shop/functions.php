...
if($pagenow == 'index.php' || $pagenow == 'themes.php'){
    ...
    if ( isset( $_GET['hide_admin_notice'] ) ) {
         update_option('best_shop_hide_admin_notice', 'ja-dismiss-notice');
    } else {
        $best_shop_notice = get_option('best_shop_hide_admin_notice', '');
        if ($best_shop_notice != 'ja-dismiss-notice' || $best_shop_notice == '') {	
...
function best_shop_admin_notice_info() {
	...
	<a class="best-shop-btn-get-started button button-primary best-shop-button-padding" href="#" data-name="" data-slug="" >'.esc_html__("Install Demo and Complete installation... ","best-shop").'</a>	
